      ...
      <Container className="space-y-10">
        <Reveal>
          <SectionHeading
            ...
            description={portfolio.profile.availability}
          />
        </Reveal>
          ...
          <Reveal>
            <article className="section-card rounded-[1.5rem] p-6 sm:p-8">
              ...
              <p className="mt-4 max-w-xl text-base leading-8 text-slate-300">
                If you&apos;re hiring, shipping a product, or need a full-stack
                developer who enjoys secure systems and real-time experiences,
                I&apos;d love to hear about it.
              </p>
              <a
                href={`mailto:${portfolio.profile.email}`}
                className="mt-6 inline-flex rounded-full border border-accent/50 bg-accent px-5 py-3 text-sm font-medium text-slate-950 transition hover:bg-accent-strong"
              >
              ...
              <div className="mt-5 space-y-4">
                {portfolio.socials.map((item) => (
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="flex items-center justify-between rounded-2xl border border-border px-4 py-4 text-slate-200 transition hover:border-accent hover:text-accent-strong"
                  >
